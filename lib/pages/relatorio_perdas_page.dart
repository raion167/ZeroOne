...
class _RelatorioPerdasPageState extends State<RelatorioPerdasPage> {
    ...
    switch (tipoGrafico) {
      case "Linhas":
        return SfCartesianChart(
          title: ChartTitle(text: "Relatório de Perdas"),
      ...
      case "Pizza":
        return SfCircularChart(
          title: ChartTitle(text: "Distribuição de Perdas"),
  ...
  Widget _buildGraficoComparativo() {
    Map<String, num> perdasPorUsuario = {};
    ...
    return SfCartesianChart(
      title: ChartTitle(text: "Comparativo de Perdas por Usuário"),
      primaryXAxis: CategoryAxis(),
